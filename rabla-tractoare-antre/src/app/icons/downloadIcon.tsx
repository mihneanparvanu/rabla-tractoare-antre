...
export const DownloadIcon: React.FC<DownloadIconProps> = ( {className }) => (
    ...
    >
        ...
        <line x1="27.5" y1="-2.84124e-07" x2="27.5" y2="21" stroke="white" strokeWidth="13" />
        <g filter="url(#filter0_d_563_17)">
            <path d="M28 37L12.4115 19L43.5885 19L28 37Z" fill="white" />
        </g>
        <defs>
            <filter id="filter0_d_563_17" x="9.61156" y="18.6" width="36.7769" height="23.6" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
